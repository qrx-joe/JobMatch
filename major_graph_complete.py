...
class CompleteMajorGraph(MajorRelationGraph):
        ...
        major_data = {
            ...
            "经济学类": {
                ...
                "majors": [
                    ...
                    {"name": "经济统计学", "code": "020102", "related": ["统计学", "经济学", "数据科学"]},
            ...
            "法学类": {
                ...
                "majors": [
                    ...
                    {"name": "信用风险管理与法律防控", "code": "030104", "related": ["法学", "金融学"]},
            ...
            "政治学类": {
                "code": "0302",
                "majors": [
                    {"name": "政治学与行政学", "code": "030201", "related": ["行政管理", "公共管理"]},
                    {"name": "国际政治", "code": "030202", "related": ["外交学", "国际关系"]},
                    {"name": "外交学", "code": "030203", "related": ["国际政治", "外语"]},
                    {"name": "国际事务与国际关系", "code": "030204", "related": ["国际政治", "外交学"]},
                    {"name": "政治学、经济学与哲学", "code": "030205", "related": ["政治学", "经济学", "哲学"]},
                ]
            },
            "社会学类": {
                "code": "0303",
                "majors": [
                    ...
                    {"name": "社会工作", "code": "030302", "related": ["社会学", "心理学", "公共管理"]},
            ...
            "马克思主义理论类": {
                "code": "0305",
                "majors": [
                    {"name": "科学社会主义", "code": "030501", "related": ["马克思主义理论", "政治学"]},
                    {"name": "中国共产党历史", "code": "030502", "related": ["历史学", "马克思主义理论"]},
                    {"name": "思想政治教育", "code": "030503", "related": ["教育学", "马克思主义理论"]},
            ...
            "教育学类": {
                ...
                "majors": [
                    ...
                    {"name": "教育技术学", "code": "040104", "related": ["教育学", "计算机", "心理学"]},
                    ...
                    {"name": "教育康复学", "code": "040110", "related": ["教育学", "康复医学", "心理学"]},
                    {"name": "卫生教育", "code": "040111", "related": ["教育学", "医学"]},
                    {"name": "认知科学与技术", "code": "040112", "related": ["教育学", "心理学", "计算机"]},
                ]
            },
            "体育学类": {
                "code": "0402",
                "majors": [
                    ...
                    {"name": "社会体育指导与管理", "code": "040203", "related": ["体育学", "管理学"]},
                    {"name": "武术与民族传统体育", "code": "040204", "related": ["体育学", "民族学"]},
                    {"name": "运动人体科学", "code": "040205", "related": ["体育学", "医学", "生物学"]},
            ...
            "中国语言文学类": {
                "code": "0501",
                "majors": [
                    {"name": "汉语言文学", "code": "050101", "related": ["汉语言", "新闻学", "教育学"]},
                    {"name": "汉语言", "code": "050102", "related": ["汉语言文学", "语言学"]},
                    {"name": "汉语国际教育", "code": "050103", "related": ["汉语言文学", "外语", "教育学"]},
                    {"name": "中国少数民族语言文学", "code": "050104", "related": ["汉语言文学", "民族学"]},
            ...
            "数学类": {
                "code": "0701",
                "majors": [
                    {"name": "数学与应用数学", "code": "070101", "related": ["统计学", "计算机", "物理学"]},
                    {"name": "信息与计算科学", "code": "070102", "related": ["数学", "计算机", "数据科学"]},
                    {"name": "数理基础科学", "code": "070103", "related": ["数学", "物理学"]},
                    {"name": "数据计算及应用", "code": "070104", "related": ["数学", "统计学", "计算机"]},
                ]
            },
            "物理学类": {
                "code": "0702",
                "majors": [
                    ...
                    {"name": "应用物理学", "code": "070202", "related": ["物理学", "材料科学", "电子"]},
                    {"name": "核物理", "code": "070203", "related": ["物理学", "核工程"]},
                    {"name": "声学", "code": "070204", "related": ["物理学", "电子", "通信"]},
                    {"name": "系统科学与工程", "code": "070205", "related": ["物理学", "计算机", "管理学"]},
                ]
            },
            "化学类": {
                "code": "0703",
            ...
            "生物科学类": {
                ...
                "majors": [
                    ...
                    {"name": "生物信息学", "code": "071003", "related": ["生物学", "计算机", "统计学"]},
            ...
            "计算机类": {
                ...
                "majors": [
                    ...
                    {"name": "数字媒体技术", "code": "080906", "related": ["计算机", "设计", "传媒"]},
                    ...
                    {"name": "人工智能", "code": "080717", "related": ["计算机", "数学", "认知科学"]},
                ]
            },
            "电子信息类": {
                "code": "0807",
                "majors": [
                    ...
                    {"name": "光电信息科学与工程", "code": "080705", "related": ["光学", "电子", "物理"]},
            ...
            "临床医学类": {
                "code": "1002",
                "majors": [
                    {"name": "临床医学", "code": "100201", "related": ["医学影像学", "麻醉学", "儿科学"]},
            ...
            "公共卫生与预防医学类": {
                ...
                "majors": [
                    ...
                    {"name": "食品卫生与营养学", "code": "100402", "related": ["预防医学", "营养学"]},
                    {"name": "妇幼保健医学", "code": "100403", "related": ["预防医学", "临床医学", "儿科"]},
            ...
            "护理学类": {
                ...
                "majors": [
                    ...
                    {"name": "助产学", "code": "101102", "related": ["护理学", "临床医学", "妇产科"]},
                ]
            },
            ...
            "管理科学与工程类": {
                ...
                "majors": [
                    ...
                    {"name": "信息管理与信息系统", "code": "120102", "related": ["管理学", "计算机", "信息系统"]},
                    {"name": "工程管理", "code": "120103", "related": ["管理学", "土木工程", "经济学"]},
                    {"name": "房地产开发与管理", "code": "120104", "related": ["管理学", "经济学", "土木工程"]},
                    {"name": "工程造价", "code": "120105", "related": ["管理学", "工程", "经济学"]},
                    {"name": "大数据管理与应用", "code": "120108", "related": ["管理学", "数据科学", "计算机"]},
                ]
            },
            "工商管理类": {
                "code": "1202",
                "majors": [
                    {"name": "工商管理", "code": "120201", "related": ["市场营销", "人力资源管理", "财务管理"]},
                    {"name": "市场营销", "code": "120202", "related": ["工商管理", "广告学", "心理学"]},
                    {"name": "会计学", "code": "120203", "related": ["财务管理", "审计学", "经济学"]},
                    {"name": "财务管理", "code": "120204", "related": ["会计学", "金融学", "经济学"]},
                    {"name": "国际商务", "code": "120205", "related": ["工商管理", "国际贸易", "外语"]},
                    {"name": "人力资源管理", "code": "120206", "related": ["工商管理", "心理学", "劳动经济学"]},
                    {"name": "审计学", "code": "120207", "related": ["会计学", "财务管理", "法学"]},
                    {"name": "资产评估", "code": "120208", "related": ["会计学", "金融学", "经济学"]},
                    {"name": "物业管理", "code": "120209", "related": ["工商管理", "房地产", "服务管理"]},
                    {"name": "文化产业管理", "code": "120210", "related": ["工商管理", "文化产业", "艺术管理"]},
                ]
            },
            "公共管理类": {
                "code": "1204",
                "majors": [
                    {"name": "公共事业管理", "code": "120401", "related": ["行政管理", "社会学", "管理学"]},
                    {"name": "行政管理", "code": "120402", "related": ["公共管理", "政治学", "法学"]},
                    {"name": "劳动与社会保障", "code": "120403", "related": ["公共管理", "人力资源管理", "社会学"]},
                    {"name": "土地资源管理", "code": "120404", "related": ["公共管理", "地理学", "经济学"]},
                    {"name": "城市管理", "code": "120405", "related": ["公共管理", "城市规划", "管理学"]},
                    {"name": "海关管理", "code": "120406", "related": ["公共管理", "国际贸易", "法学"]},
                    {"name": "交通管理", "code": "120407", "related": ["公共管理", "交通运输", "管理学"]},
                    {"name": "海事管理", "code": "120408", "related": ["公共管理", "航运", "法学"]},
                    {"name": "公共关系学", "code": "120409", "related": ["公共管理", "传播学", "管理学"]},
                    {"name": "健康服务与管理", "code": "120410", "related": ["公共管理", "医学", "管理学"]},
                ]
            },
        }
    ...
    def compare_majors(self, major1: str, major2: str) -> dict:
        ...
        # 关联度评分
        if same_category:
            comparison["关联度"] = {"score": 100, "level": "完全相关", "reason": "同属" + node1.category}
        ...
        if same_category or major2 in node1.related:
            ...
            comparison["报考建议"] = f"[MAYBE] {major1}可能可以报考要求{major2}的岗位（建议咨询招考单位）"
        else:
